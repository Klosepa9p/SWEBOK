...
//  Data Clumps ortadan kaldırılarak kodun modülerliği artırıldı.//Açıklama: Düzeltilmiş kodda, adres bilgileri (street, city, postalCode) bir Address 
//sınıfında ve zaman bilgileri (startHour, startMinute, endHour, endMinute) 
